...
export default async function ServerListContainer({ query }: { query: Query }) {
    ...
    return (
        <div className="rounded border overflow-hidden">
            <div className="px-4 py-3 bg-zinc-100 text-sm text-zinc-600">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t bg-white">
                <Link
                    ...
                    className={`px-3 py-1 rounded border ${data.page <= 1 ? 'pointer-events-none text-zinc-400 bg-zinc-100' : 'bg-white hover:bg-zinc-50'}`}
                ...
                <Link
                    ...
                    className={`px-3 py-1 rounded border ${data.page >= totalPages ? 'pointer-events-none text-zinc-400 bg-zinc-100' : 'bg-white hover:bg-zinc-50'}`}
