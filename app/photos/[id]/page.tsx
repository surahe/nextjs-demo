...
export default async function PhotoDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-zinc-50 font-sans dark:bg-zinc-950">
            {/* 说明栏：硬导航时才会看到这个完整页面 */}
            <div className="flex items-center gap-4 border-b bg-white px-6 py-3 dark:bg-zinc-900">
                <Link
                    href="/photos"
            ...
            <div className="flex flex-1 items-center justify-center p-10">
                <div className="w-full max-w-md overflow-hidden rounded-2xl border bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
                    <div
                    ...
                    <div className="p-6">
                        ...
                        <p className="mt-1 text-sm text-zinc-500">Photo #{photo.id}</p>
