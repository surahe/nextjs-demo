 ...
 */
export default function FileStructureLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen bg-zinc-50 font-sans dark:bg-zinc-950">
            {/* Layout 层可见标识 */}
            <div className="border-b-4 border-purple-500 bg-purple-50 px-6 py-3 dark:bg-purple-950">
